...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(e,t,n){let r=new Float32Array(Ha),i=new U(0,1,0);return new Ii({name:`SphericalGaussianBlur`,defines:{n:Ha,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Ii({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Y(){return new Ii({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
	...
	`}var ao=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new wi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Kc=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),X=o(((e,t)=>{t.exports=Kc()}))(),qc=({settings:e,onReady:t})=>{let n=(0,_.useRef)(null),r=(0,_.useRef)(40),i=(0,_.useRef)(e);return(0,_.useEffect)(()=>{i.current=e},[e]),(0,_.useEffect)(()=>{if(!n.current)return;let e=Date.now(),a=new In;a.fog=new Fn(131589,.015);let o=new la(75,window.innerWidth/window.innerHeight,.1,1e3);o.position.z=40;let s=new Uc({antialias:!1,powerPreference:`high-performance`});s.setSize(window.innerWidth,window.innerHeight),s.setPixelRatio(Math.min(window.devicePixelRatio,2)),s.setClearColor(131589),n.current.appendChild(s.domElement);let c=800*15,l=new Float32Array(c*3),u=new Float32Array(c),d=new Float32Array(c*3),f=[],p=0;for(let e=0;e<800;e++){let e=Math.random(),t=Math.random(),n=Math.random();for(let r=0;r<15;r++)u[p]=r/14,d[p*3]=e,d[p*3+1]=t,d[p*3+2]=n,r<14&&f.push(p,p+1),p++}let m=new Ar;m.setAttribute(`position`,new hr(l,3)),m.setAttribute(`aLineIndex`,new hr(u,1)),m.setAttribute(`aRandom`,new hr(d,3)),m.setIndex(f);let h=new Ii({vertexShader:Wc,fragmentShader:Gc,uniforms:{uTime:{value:0},uGravityScale:{value:.8},uNoiseScale:{value:.1},uSpeed:{value:1.5},uBloomOverride:{value:.6},uMouse:{value:new Ot(-9999,-9999)},uAspect:{value:window.innerWidth/window.innerHeight}},transparent:!0,blending:2,depthWrite:!1,linewidth:1}),g=new Ci(m,h);a.add(g);let _=new Ot(-9999,-9999),v=new Ot(-9999,-9999),y=e=>{_.x=e.clientX/window.innerWidth*2-1,_.y=-(e.clientY/window.innerHeight)*2+1},b=e=>{r.current+=e.deltaY*.05,r.current=Math.max(10,Math.min(150,r.current))};window.addEventListener(`mousemove`,y),window.addEventListener(`wheel`,b,{passive:!0});let x,S=()=>{let n=(Date.now()-e)*.001;h.uniforms.uTime.value=n,h.uniforms.uGravityScale.value=i.current.gravity,h.uniforms.uSpeed.value=i.current.timeSpeed,h.uniforms.uBloomOverride.value=i.current.bloomStrength,_.x===-9999?(v.x=Math.sin(n*1.5)*.4,v.y=Math.cos(n*2)*.3,h.uniforms.uMouse.value.set(v.x,v.y)):(v.x===-9999&&v.copy(_),v.lerp(_,.1),h.uniforms.uMouse.value.set(v.x,v.y)),g.rotation.y=n*.05,g.rotation.z=n*.02;let c=r.current;o.position.z+=(c-o.position.z)*.05,_.x!==-9999&&(o.position.x+=(v.x*12-o.position.x)*.04,o.position.y+=(v.y*12-o.position.y)*.04,o.lookAt(0,0,0)),s.render(a,o),C||(C=!0,setTimeout(()=>{t&&t()},50)),x=requestAnimationFrame(S)},C=!1;S();let w=()=>{o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight),h.uniforms.uAspect.value=window.innerWidth/window.innerHeight};return window.addEventListener(`resize`,w),()=>{window.removeEventListener(`resize`,w),window.removeEventListener(`mousemove`,y),window.removeEventListener(`wheel`,b),cancelAnimationFrame(x),n.current&&s.domElement&&n.current.removeChild(s.domElement),m.dispose(),h.dispose(),s.dispose()}},[]),(0,X.jsx)(`div`,{ref:n,className:`particle-container`})},Jc=({settings:e,setSettings:t})=>{let n=(e,n)=>{t(t=>({...t,[e]:n}))};return(0,X.jsxs)(`aside`,{className:`sandbox-dashboard`,children:[(0,X.jsxs)(`div`,{className:`dashboard-header`,children:[(0,X.jsx)(`h2`,{children:`Laboratory`}),(0,X.jsx)(`p`,{children:`Change the rules of the universe.`})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`gravity`,children:`Black Hole Pull`}),(0,X.jsxs)(`span`,{className:`control-value`,children:[e.gravity.toFixed(2),`G`]})]}),(0,X.jsx)(`input`,{id:`gravity`,type:`range`,min:`0`,max:`2`,step:`0.05`,value:e.gravity,onChange:e=>n(`gravity`,parseFloat(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`How hard the invisible magnet in the center holds the universe together. Drag it to 0 to turn off gravity and watch the stars float away!`})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`timeSpeed`,children:`Time Machine`}),(0,X.jsxs)(`span`,{className:`control-value`,children:[e.timeSpeed.toFixed(1),`x`]})]}),(0,X.jsx)(`input`,{id:`timeSpeed`,type:`range`,min:`0`,max:`3`,step:`0.1`,value:e.timeSpeed,onChange:e=>n(`timeSpeed`,parseFloat(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`Control how fast the universe ages. Fast forward to see the chaotic storms spin, or drag it down to 0 to freeze time completely.`})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`bloomStrength`,children:`Starlight Glow`}),(0,X.jsx)(`span`,{className:`control-value`,children:e.bloomStrength.toFixed(2)})]}),(0,X.jsx)(`input`,{id:`bloomStrength`,type:`range`,min:`0`,max:`2.5`,step:`0.05`,value:e.bloomStrength,onChange:e=>n(`bloomStrength`,parseFloat(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`Turn up the hidden energy of the tendrils, making them burn brighter and bleed magical neon light into the deep space around them.`})]})]})};function Yc(){let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)({gravity:.8,timeSpeed:1.5,vortexScale:1,bloomStrength:.6});return(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`div`,{className:`loading-screen ${i?`out`:``}`,children:[(0,X.jsx)(`div`,{className:`loader-ring`}),(0,X.jsx)(`p`,{children:`INITIALIZING MACRO-PHYSICS...`})]}),(0,X.jsx)(qc,{settings:o,onReady:()=>a(!0)}),(0,X.jsx)(`main`,{className:`hero-overlay`,children:(0,X.jsxs)(`div`,{className:`title-container`,children:[(0,X.jsx)(`h1`,{className:`hero-title`,children:`Cosmic Entropy`}),(0,X.jsxs)(`div`,{className:`subtitle-row`,children:[(0,X.jsx)(`p`,{className:`hero-subtitle`,children:`Transcendental Particles`}),(0,X.jsx)(`button`,{className:`science-trigger`,onClick:()=>r(!n),children:n?`HIDE`:`READ THE SCIENCE`})]}),n&&(0,X.jsxs)(`div`,{className:`science-summary`,children:[(0,X.jsxs)(`p`,{children:[`This sandbox is an interactive WebGL simulation modeling the fundamental struggle that shapes our universe: the battle between `,(0,X.jsx)(`strong`,{children:`Gravity`}),` and `,(0,X.jsx)(`strong`,{children:`Thermodynamic Entropy`}),`.`]}),(0,X.jsxs)(`p`,{children:[`In astrophysics, the universe is organized into a massive, interconnected lattice called the `,(0,X.jsx)(`strong`,{children:`Cosmic Web`}),`. This web exists purely because of Gravity pulling particles into dense nodes and trailing filaments.`]}),(0,X.jsxs)(`p`,{children:[`However, gravity is constantly fighting a losing battle against `,(0,X.jsx)(`strong`,{children:`Entropy`}),` and `,(0,X.jsx)(`strong`,{children:`Dark Energy`}),`—the forces pushing space apart. The twisting, chaotic "fluids" you see here are generated using 4D Perlin Noise to represent this entropic counter-force.`]}),(0,X.jsx)(`p`,{children:`When you scale down the Gravity slider, you are effectively watching Cosmic Heat Death in real time: the entropic noise overpowers the gravitational bonds, and the fluid dynamics scatter the organized starlight back into the infinite, unstructured void.`})]})]})}),(0,X.jsx)(`div`,{className:`dashboard-wrapper ${e?`visible`:`hidden`}`,children:(0,X.jsx)(Jc,{settings:o,setSettings:s})}),(0,X.jsx)(`button`,{className:`info-toggle ${e?`active`:``}`,onClick:()=>t(!e),"aria-label":`Toggle Physics Sandbox`,children:e?(0,X.jsx)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M6 18L18 6M6 6l12 12`})}):(0,X.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z`}),(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M15 12a3 3 0 11-6 0 3 3 0 016 0z`})]})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(Yc,{})}));