...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(e,t,n){let r=new Float32Array(za),i=new V(0,1,0);return new ji({name:`SphericalGaussianBlur`,defines:{n:za,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:no(),fragmentShader:`
	...
	`}var ro=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new yi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ds={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Os(e,t){let n=Ds[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ks=new V;function As(){return U.getLuminanceCoefficients(ks),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ks.x.toFixed(4)}, ${ks.y.toFixed(4)}, ${ks.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ys(i,i.VERTEX_SHADER,y),S=ys(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ts(i,x,`vertex`),n=Ts(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,Hc={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},$c=class e extends Uc{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new B(256,256):new B(e.x,e.y),this.clearColor=new W(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Xt(i,a,{type:ae}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Xt(i,a,{type:ae});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Xt(i,a,{type:ae});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=Qc;this.highPassUniforms=G.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new ji({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new B(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new V(1,1,1),new V(1,1,1),new V(1,1,1),new V(1,1,1),new V(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=G.clone(Hc.uniforms),this.blendMaterial=new ji({uniforms:this.copyUniforms,vertexShader:Hc.vertexShader,fragmentShader:Hc.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new W,this._oldClearAlpha=1,this._basic=new Hr,this._fsQuad=new Kc(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new B(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new ji({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new B(.5,.5)},direction:{value:new B(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};$c.BlurDirectionX=new B(1,0),$c.BlurDirectionY=new B(0,1);var el=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),X=o(((e,t)=>{t.exports=el()}))(),tl=({settings:e,onReady:t,onInteract:n})=>{let r=(0,_.useRef)(null),i=(0,_.useRef)(40),a=(0,_.useRef)(e);return(0,_.useEffect)(()=>{a.current=e},[e]),(0,_.useEffect)(()=>{if(!r.current)return;let e=Date.now(),o=new Ln;o.fog=new In(131589,.015);let s=window.innerWidth/window.innerHeight,c=new ia(75,s,.1,1e3),l=e=>e<1?40/e:40;c.position.z=l(s),i.current=c.position.z;let u=new zc({antialias:!1,powerPreference:`high-performance`});u.setSize(window.innerWidth,window.innerHeight),u.setPixelRatio(Math.min(window.devicePixelRatio,2)),u.setClearColor(131589),r.current.appendChild(u.domElement);let d=new Zc(o,c),f=new $c(new B(window.innerWidth,window.innerHeight),1.5,.4,.85);f.strength=1.5,f.radius=1,f.threshold=.1;let p=new Xc(u);p.addPass(d),p.addPass(f);let m=1e4,h=new Float32Array(m*3),g=new Float32Array(m*3);for(let e=0;e<m;e++)g[e*3]=Math.random(),g[e*3+1]=Math.random(),g[e*3+2]=Math.random();let _=new jr;_.setAttribute(`position`,new gr(h,3)),_.setAttribute(`aRandom`,new gr(g,3));let v=new ji({vertexShader:Bc,fragmentShader:Vc,uniforms:{uTime:{value:0},uGravityScale:{value:.8},uNoiseScale:{value:.1},uSpeed:{value:1.5},uBloomOverride:{value:.6},uMouse:{value:new B(-9999,-9999)},uAspect:{value:window.innerWidth/window.innerHeight}},transparent:!0,blending:2,depthWrite:!1}),y=new _i(_,v);o.add(y);let b=new B(-9999,-9999),x=new B(-9999,-9999),S=0,C=e=>{if(e.target&&e.target.closest&&e.target.closest(`.dashboard-wrapper`)){b.x=-9999,b.y=-9999;return}let t=0,r=0;if(`touches`in e)if(e.touches.length>0)t=e.touches[0].clientX,r=e.touches[0].clientY;else return;else t=e.clientX,r=e.clientY;b.x=t/window.innerWidth*2-1,b.y=-(r/window.innerHeight)*2+1;let i=Date.now();i-S>500&&(n&&n(),S=i)},w=e=>{i.current+=e.deltaY*.05,i.current=Math.max(10,Math.min(150,i.current))};window.addEventListener(`mousemove`,C),window.addEventListener(`touchmove`,C,{passive:!1}),window.addEventListener(`touchstart`,C,{passive:!1}),window.addEventListener(`wheel`,w,{passive:!0});let T,E=()=>{let n=(Date.now()-e)*2e-4;v.uniforms.uTime.value=n,v.uniforms.uGravityScale.value=a.current.density;let r=.25;a.current.epoch<.5?r=1.6:a.current.epoch>1.5&&(r=.005),v.uniforms.uSpeed.value+=(r-v.uniforms.uSpeed.value)*.05,v.uniforms.uBloomOverride.value=a.current.darkEnergy,f.strength=.05+a.current.darkEnergy*.15,b.x===-9999?v.uniforms.uMouse.value.set(-9999,-9999):(x.x===-9999&&x.copy(b),x.lerp(b,.04),v.uniforms.uMouse.value.set(x.x,x.y)),y.rotation.y=n*.05,y.rotation.z=n*.02;let s=i.current;c.position.z+=(s-c.position.z)*.05,b.x!==-9999&&(c.position.x+=(x.x*12-c.position.x)*.04,c.position.y+=(x.y*12-c.position.y)*.04,c.lookAt(0,0,0));let l=Date.now();O++,l-ee>=1e3&&(!k&&n>3&&O<45&&(console.warn(`Transcendental Engine: Hardware limit detected! Auto-downgrading from Cinematic Bloom to Native Render to preserve interactivity...`),k=!0),O=0,ee=l),k?u.render(o,c):p.render(),D||(D=!0,setTimeout(()=>{t&&t()},50)),T=requestAnimationFrame(E)},D=!1,O=0,ee=Date.now(),k=!1;requestAnimationFrame(()=>{requestAnimationFrame(()=>{E()})});let te=()=>{let e=window.innerWidth/window.innerHeight;c.aspect=e,c.updateProjectionMatrix(),u.setSize(window.innerWidth,window.innerHeight),p.setSize(window.innerWidth,window.innerHeight),v.uniforms.uAspect.value=e,i.current=e<1?40/e:40};return window.addEventListener(`resize`,te),()=>{window.removeEventListener(`resize`,te),window.removeEventListener(`mousemove`,C),window.removeEventListener(`touchmove`,C),window.removeEventListener(`touchstart`,C),window.removeEventListener(`wheel`,w),cancelAnimationFrame(T),r.current&&u.domElement&&r.current.removeChild(u.domElement),_.dispose(),v.dispose(),u.dispose()}},[]),(0,X.jsx)(`div`,{ref:r,className:`particle-container`})},nl=({settings:e,setSettings:t})=>{let n=(e,n)=>{t(t=>({...t,[e]:n}))},r=e=>{let n=e/2,r=.8;r=n<.5?2-n*2*1.2:.8-(n-.5)*2*.8;let i=1.5;i=n<.5?2.5-n*2*1:1.5+(n-.5)*2*1.5;let a=.6;a=n<.5?2-n*2*1.4:.6-(n-.5)*2*.6,t({epoch:e,density:r,expansion:i,darkEnergy:a})},i=e=>{switch(e){case`plasma`:t({epoch:0,density:2,expansion:2.5,darkEnergy:2});break;case`current`:t({epoch:1,density:.8,expansion:1,darkEnergy:.7});break;case`heat_death`:t({epoch:2,density:0,expansion:3,darkEnergy:0});break}};return(0,X.jsxs)(`aside`,{className:`sandbox-dashboard`,children:[(0,X.jsxs)(`div`,{className:`dashboard-header`,children:[(0,X.jsx)(`h2`,{children:`Interactive Sandbox`}),(0,X.jsx)(`p`,{children:`Mathematical Constraints of the Universe`})]}),(0,X.jsxs)(`div`,{className:`mechanic-hint`,children:[(0,X.jsx)(`strong`,{children:`🥣 The Cosmic Soup:`}),`The glowing dots represent matter moving through space. High heat makes them bounce faster, while low temperatures slow them down!`,(0,X.jsxs)(`div`,{style:{marginTop:`0.4rem`,marginBottom:`0.4rem`,padding:`0.4rem`,background:`rgba(0,0,0,0.2)`,borderRadius:`4px`},children:[(0,X.jsx)(`strong`,{children:`🌡️ Temperature Scale:`}),(0,X.jsx)(`br`,{}),`🔥 `,(0,X.jsx)(`span`,{style:{color:`#fbbf24`},children:`Yellow`}),`/`,(0,X.jsx)(`span`,{style:{color:`#f43f5e`},children:`Red`}),` = Boiling Hot & Fast`,(0,X.jsx)(`br`,{}),`❄️ `,(0,X.jsx)(`span`,{style:{color:`#a855f7`},children:`Magenta`}),`/`,(0,X.jsx)(`span`,{style:{color:`#3b82f6`},children:`Blue`}),` = Freezing & Slow`]}),(0,X.jsx)(`strong`,{children:`🎮 Interactive Physics Tool:`}),`Your mouse represents a `,(0,X.jsx)(`em`,{children:`Supermassive Black Hole`}),`. Move it around the canvas to bend gravity and scoop the soup into glowing galaxies!`]}),(0,X.jsxs)(`div`,{className:`preset-buttons`,children:[(0,X.jsx)(`button`,{onClick:()=>i(`plasma`),title:`Primordial Chaos`,children:`🔥 The Big Bang`}),(0,X.jsx)(`button`,{onClick:()=>i(`current`),title:`Our Current Universe`,children:`🌎 Our Galaxy`}),(0,X.jsx)(`button`,{onClick:()=>i(`heat_death`),title:`Absolute Zero Freezing`,children:`❄️ The Big Freeze`})]}),(0,X.jsxs)(`div`,{className:`control-group epoch-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`epoch`,children:`Cosmological Timeline`}),(0,X.jsx)(`span`,{className:`control-value`,children:[`Plasma`,`Cosmic Web`,`Heat Death`][e.epoch]||`Custom`})]}),(0,X.jsx)(`input`,{id:`epoch`,type:`range`,min:`0`,max:`2`,step:`1`,value:e.epoch,onChange:e=>r(parseInt(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`Travel through Time: Start at the super hot beginning, watch gravity slowly clump the soup together into stars, and end with everything frozen and drifting in the dark.`})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`density`,children:`Matter Density (Ωm)`}),(0,X.jsx)(`span`,{className:`control-value`,children:e.density.toFixed(2)})]}),(0,X.jsx)(`input`,{id:`density`,type:`range`,min:`0`,max:`2`,step:`0.05`,value:e.density,onChange:e=>n(`density`,parseFloat(e.target.value))}),(0,X.jsxs)(`div`,{className:`control-tooltip`,children:[`This changes how much "stuff" (gravity) is in the universe. Too much stuff pulls everything together into a crush! Too little stuff lets everything float away forever.`,(0,X.jsx)(`strong`,{style:{display:`block`,marginTop:`4px`,color:`#0df`},children:e.density>1.8?`State: Everything Squished Together!`:e.density<.2?`State: Floating Away...`:`State: Balanced Space Web`})]})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`expansion`,children:`Hubble Expansion (H0)`}),(0,X.jsxs)(`span`,{className:`control-value`,children:[e.expansion.toFixed(1),`x`]})]}),(0,X.jsx)(`input`,{id:`expansion`,type:`range`,min:`0.1`,max:`3`,step:`0.1`,value:e.expansion,onChange:e=>n(`expansion`,parseFloat(e.target.value))}),(0,X.jsxs)(`div`,{className:`control-tooltip`,children:[`This changes how fast the universe is stretching like a giant rubber band!`,(0,X.jsx)(`strong`,{style:{display:`block`,marginTop:`4px`,color:`#0df`},children:e.expansion>2.2?`State: Ripping Apart!`:e.expansion<.5?`State: Frozen in Place`:`State: Growing Smoothly`})]})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`darkEnergy`,children:`Dark Energy (ΩΛ)`}),(0,X.jsx)(`span`,{className:`control-value`,children:e.darkEnergy.toFixed(2)})]}),(0,X.jsx)(`input`,{id:`darkEnergy`,type:`range`,min:`0`,max:`2.5`,step:`0.05`,value:e.darkEnergy,onChange:e=>n(`darkEnergy`,parseFloat(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`The latent repulsive energy hidden in the vacuum of space. Increases the amplitude of the entropic noise function and thermal bloom.`})]})]})};function rl(){let[e,t]=(0,_.useState)(window.innerWidth>768),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)({epoch:0,density:2,expansion:2.5,darkEnergy:2}),[u,d]=(0,_.useState)(`We are at the beginning of Time. Try moving the sliders or your mouse!`);return(0,_.useEffect)(()=>{if(c.epoch===0&&c.density===2&&c.expansion===2.5){d(`🔥 THE BIG BANG: It's so hot the cosmic soup is violently boiling! The extreme heat makes the particles bounce frantically.`);return}if(c.epoch===2&&c.density===0&&c.expansion===3){d(`❄️ THE BIG FREEZE: The universe has expanded too far! The soup has run out of heat, freezing the particles completely solid.`);return}if(c.epoch===1&&c.density===.8&&c.expansion===1){d(`🌎 OUR GALAXY: A perfect balance of heat and gravity! Watch the soup naturally clump together into swirling, beautiful galaxies.`);return}if(o){d(`✨ WOW: You made a galaxy! Your giant gravity well clumped the soup together into a solid chunk!`);return}if(c.expansion>2){d(`🚨 WARNING: The universe is stretching way too fast! The soup is flying apart!`);return}if(c.density<.2){d(`🚨 WARNING: There isn't enough gravity left! Galaxies are floating away from each other.`);return}c.epoch<.5?d(`🪐 The Cosmic Soup: Everything is super hot! The particles bounce around like crazy!`):c.epoch>1.5?d(`❄️ Time Travel: Approaching absolute zero... the soup is freezing.`):d(`🪐 The Cosmic Soup: Cooling down! Gravity is taking over.`)},[c,o]),(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`div`,{className:`loading-screen ${i?`out`:``}`,children:[(0,X.jsx)(`div`,{className:`loader-ring`}),(0,X.jsx)(`p`,{children:`INITIALIZING MACRO-PHYSICS...`})]}),(0,X.jsx)(`nav`,{className:`top-nav`,children:(0,X.jsx)(`a`,{href:`https://amberbockel.com`,className:`nav-logo`,"aria-label":`Amber Bockel`,children:(0,X.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 110 44`,fill:`currentColor`,"aria-hidden":`true`,children:[(0,X.jsx)(`g`,{transform:`translate(37.647 11.44)`,children:(0,X.jsx)(`path`,{d:`M 10.996 13.894 C 8.33 13.894 6.154 16.389 4.55 19.427 L 6.644 7.464 L 6.536 7.464 C 5.501 8.115 4.495 8.441 3.299 8.631 L 3.299 8.739 C 3.842 9.363 4.115 9.851 4.006 10.827 C 3.87 11.778 1.666 23.279 1.666 24.608 C 1.666 27.213 3.625 28.488 6.018 28.488 C 10.833 28.488 14.532 23.361 14.532 18.234 C 14.532 15.439 13.199 13.894 10.996 13.894 Z M 6.1 28.163 C 4.522 28.163 3.651 27.159 3.651 25.233 C 3.651 24.283 3.951 22.764 4.387 20.242 C 5.855 17.393 7.814 15.033 10.153 15.033 C 11.512 15.033 12.356 16.145 12.356 18.261 C 12.356 22.357 9.827 28.163 6.1 28.163 Z M 20.434 28.488 
 13.167 57.121 11.537 58.466 10.174 C 59.814 8.811 61.448 8.123 63.369 8.107 C 65.274 8.088 66.909 8.751 68.273 10.091 C 69.639 11.436 70.332 13.066 70.35 14.982 Z M 63.397 11.627 C 62.447 11.627 61.639 11.959 60.975 12.621 C 60.631 12.997 60.388 13.373 60.244 13.749 L 66.577 13.749 C 66.432 13.373 66.182 12.988 65.824 12.594 C 65.14 11.95 64.331 11.627 63.397 11.627 Z M 74.957 10.174 C 75.261 9.315 75.772 8.715 76.492 8.373 C 77.193 8.033 78.244 7.864 79.645 7.864 L 79.645 11.705 C 78.278 11.705 77.137 12.171 76.221 13.103 C 75.378 13.927 74.957 14.833 74.957 15.816 L 74.957 21.944 L 71.184 21.944 L 71.184 8.107 L 74.957 8.107 Z`})})]})})}),(0,X.jsx)(tl,{settings:c,onReady:()=>a(!0),onInteract:()=>s(e=>!e)}),(0,X.jsx)(`main`,{className:`hero-overlay`,children:(0,X.jsxs)(`div`,{className:`title-container`,children:[(0,X.jsx)(`h1`,{className:`hero-title`,children:`Cosmic Entropy`}),(0,X.jsxs)(`div`,{className:`subtitle-row`,children:[(0,X.jsx)(`p`,{className:`hero-subtitle`,children:`An Interactive Physics Sandbox`}),(0,X.jsx)(`button`,{className:`science-trigger`,onClick:()=>r(!n),children:n?`HIDE`:`HOW IT WORKS`})]}),n&&(0,X.jsxs)(`div`,{className:`science-summary`,children:[(0,X.jsxs)(`p`,{children:[`Welcome to the `,(0,X.jsx)(`strong`,{children:`Cosmic Soup!`}),` This sandbox lets you play with the mathematical rules that control the entire universe.`]}),(0,X.jsxs)(`p`,{children:[`The universe is governed by `,(0,X.jsx)(`strong`,{children:`Thermodynamics`}),`. Basically: things that are hot have lots of energy and bounce around incredibly fast! Things that are cold lose their energy, slow down, and eventually freeze dead in their tracks.`]}),(0,X.jsxs)(`p`,{children:[`Use the controls on the right to time-travel! If you go all the way back to the beginning of time (`,(0,X.jsx)(`strong`,{children:`The Big Bang`}),`), the universe was so hot and crowded that the soup was furiously boiling. If you travel all the way to the end of time (`,(0,X.jsx)(`strong`,{children:`Heat Death`}),`), the soup stretches so far apart that the stars completely freeze!`]})]})]})}),u&&(0,X.jsxs)(`div`,{className:`observation-hud`,children:[(0,X.jsx)(`span`,{className:`observation-badge`,children:`LIVE OBSERVATION`}),(0,X.jsx)(`p`,{className:`observation-text`,children:u})]}),(0,X.jsx)(`div`,{className:`dashboard-backdrop ${e?`visible`:`hidden`}`,onClick:()=>{window.innerWidth<=768&&t(!1)}}),(0,X.jsx)(`div`,{className:`dashboard-wrapper ${e?`visible`:`hidden`}`,children:(0,X.jsx)(nl,{settings:c,setSettings:l})}),(0,X.jsx)(`button`,{className:`info-toggle ${e?`active`:``}`,onClick:()=>t(!e),"aria-label":`Toggle Physics Sandbox`,children:e?(0,X.jsx)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M6 18L18 6M6 6l12 12`})}):(0,X.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z`}),(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M15 12a3 3 0 11-6 0 3 3 0 016 0z`})]})}),(0,X.jsx)(`footer`,{className:`site-footer`,children:(0,X.jsx)(`a`,{href:`https://amberbockel.com`,target:`_blank`,rel:`noopener noreferrer`,children:`A project by amberbockel.com`})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(rl,{})}));