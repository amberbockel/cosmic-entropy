...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Y(e,t,n){let r=new Float32Array(Wa),i=new H(0,1,0);return new Ii({name:`SphericalGaussianBlur`,defines:{n:Wa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:oo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function io(){return new Ii({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:oo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(){return new Ii({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:oo(),fragmentShader:`
	...
	`}var so=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new wi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Jc={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};al.BlurDirectionX=new V(1,0),al.BlurDirectionY=new V(0,1);var ol=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),X=o(((e,t)=>{t.exports=ol()}))(),sl=({settings:e,onReady:t,onInteract:n})=>{let r=(0,_.useRef)(null),i=(0,_.useRef)(40),a=(0,_.useRef)(e);return(0,_.useEffect)(()=>{a.current=e},[e]),(0,_.useEffect)(()=>{if(!r.current)return;let e=Date.now(),o=new In;o.fog=new Fn(131589,.015);let s=window.innerWidth/window.innerHeight,c=new la(75,s,.1,1e3),l=e=>e<1?40/e:40;c.position.z=l(s),i.current=c.position.z;let u=new Gc({antialias:!1,powerPreference:`high-performance`});u.setSize(window.innerWidth,window.innerHeight),u.setPixelRatio(Math.min(window.devicePixelRatio,2)),u.setClearColor(131589),r.current.appendChild(u.domElement);let d=new rl(o,c),f=new al(new V(window.innerWidth,window.innerHeight),1.5,.4,.85);f.strength=1.5,f.radius=1,f.threshold=.1;let p=new nl(u);p.addPass(d),p.addPass(f);let m=3e3,h=m*15,g=new Float32Array(h*3),_=new Float32Array(h),v=new Float32Array(h*3),y=[],b=0;for(let e=0;e<m;e++){let e=Math.random(),t=Math.random(),n=Math.random();for(let r=0;r<15;r++)_[b]=r/14,v[b*3]=e,v[b*3+1]=t,v[b*3+2]=n,r<14&&y.push(b,b+1),b++}let x=new Ar;x.setAttribute(`position`,new hr(g,3)),x.setAttribute(`aLineIndex`,new hr(_,1)),x.setAttribute(`aRandom`,new hr(v,3)),x.setIndex(y);let S=new Ii({vertexShader:Kc,fragmentShader:qc,uniforms:{uTime:{value:0},uGravityScale:{value:.8},uNoiseScale:{value:.1},uSpeed:{value:1.5},uBloomOverride:{value:.6},uMouse:{value:new V(-9999,-9999)},uAspect:{value:window.innerWidth/window.innerHeight}},transparent:!0,blending:2,depthWrite:!1,linewidth:1}),C=new Ci(x,S);o.add(C);let w=new V(-9999,-9999),T=new V(-9999,-9999),E=0,D=e=>{if(e.target&&e.target.closest&&e.target.closest(`.dashboard-wrapper`)){w.x=-9999,w.y=-9999;return}w.x=e.clientX/window.innerWidth*2-1,w.y=-(e.clientY/window.innerHeight)*2+1;let t=Date.now();t-E>500&&(n&&n(),E=t)},O=e=>{i.current+=e.deltaY*.05,i.current=Math.max(10,Math.min(150,i.current))};window.addEventListener(`mousemove`,D),window.addEventListener(`wheel`,O,{passive:!0});let ee,k=()=>{let n=(Date.now()-e)*.001;S.uniforms.uTime.value=n,S.uniforms.uGravityScale.value=a.current.density;let r=.35;a.current.epoch<.5?r=1:a.current.epoch>1.5&&(r=.05),S.uniforms.uSpeed.value+=(r-S.uniforms.uSpeed.value)*.05,S.uniforms.uBloomOverride.value=a.current.darkEnergy,f.strength=.05+a.current.darkEnergy*.15,w.x===-9999?S.uniforms.uMouse.value.set(-9999,-9999):(T.x===-9999&&T.copy(w),T.lerp(w,.04),S.uniforms.uMouse.value.set(T.x,T.y)),C.rotation.y=n*.05,C.rotation.z=n*.02;let s=i.current;c.position.z+=(s-c.position.z)*.05,w.x!==-9999&&(c.position.x+=(T.x*12-c.position.x)*.04,c.position.y+=(T.y*12-c.position.y)*.04,c.lookAt(0,0,0));let l=Date.now();ne++,l-re>=1e3&&(!A&&n>3&&ne<45&&(console.warn(`Transcendental Engine: Hardware limit detected! Auto-downgrading from Cinematic Bloom to Native Render to preserve interactivity...`),A=!0),ne=0,re=l),A?u.render(o,c):p.render(),te||(te=!0,setTimeout(()=>{t&&t()},50)),ee=requestAnimationFrame(k)},te=!1,ne=0,re=Date.now(),A=!1;requestAnimationFrame(()=>{requestAnimationFrame(()=>{k()})});let ie=()=>{let e=window.innerWidth/window.innerHeight;c.aspect=e,c.updateProjectionMatrix(),u.setSize(window.innerWidth,window.innerHeight),p.setSize(window.innerWidth,window.innerHeight),S.uniforms.uAspect.value=e,i.current=e<1?40/e:40};return window.addEventListener(`resize`,ie),()=>{window.removeEventListener(`resize`,ie),window.removeEventListener(`mousemove`,D),window.removeEventListener(`wheel`,O),cancelAnimationFrame(ee),r.current&&u.domElement&&r.current.removeChild(u.domElement),x.dispose(),S.dispose(),u.dispose()}},[]),(0,X.jsx)(`div`,{ref:r,className:`particle-container`})},cl=({settings:e,setSettings:t,observation:n})=>{let r=(e,n)=>{t(t=>({...t,[e]:n}))},i=e=>{let n=e/2,r=.8;r=n<.5?2-n*2*1.2:.8-(n-.5)*2*.8;let i=1.5;i=n<.5?2.5-n*2*1:1.5+(n-.5)*2*1.5;let a=.6;a=n<.5?2-n*2*1.4:.6-(n-.5)*2*.6,t({epoch:e,density:r,expansion:i,darkEnergy:a})},a=e=>{switch(e){case`plasma`:t({epoch:0,density:2,expansion:2.5,darkEnergy:2});break;case`current`:t({epoch:1,density:.8,expansion:1,darkEnergy:.7});break;case`heat_death`:t({epoch:2,density:0,expansion:3,darkEnergy:0});break}};return(0,X.jsxs)(`aside`,{className:`sandbox-dashboard`,children:[(0,X.jsxs)(`div`,{className:`dashboard-header`,children:[(0,X.jsx)(`h2`,{children:`Interactive Sandbox`}),(0,X.jsx)(`p`,{children:`Mathematical Constraints of the Universe`})]}),(0,X.jsxs)(`div`,{className:`mechanic-hint`,children:[(0,X.jsx)(`strong`,{children:`🕸️ The Cosmic Spider-Web:`}),`The glowing lines represent dark matter. In space, gravity weaves matter into massive, interconnected strings!`,(0,X.jsx)(`br`,{}),(0,X.jsx)(`br`,{}),(0,X.jsx)(`strong`,{children:`🎮 Interactive Physics Tool:`}),`Your mouse represents a `,(0,X.jsx)(`em`,{children:`Supermassive Black Hole`}),`. Move it around the canvas to bend gravity and twist the web into glowing galaxies!`]}),n&&(0,X.jsxs)(`div`,{className:`observation-card`,children:[(0,X.jsx)(`span`,{className:`observation-badge`,children:`LIVE OBSERVATION`}),(0,X.jsx)(`p`,{className:`observation-text`,children:n})]}),(0,X.jsxs)(`div`,{className:`preset-buttons`,children:[(0,X.jsx)(`button`,{onClick:()=>a(`current`),title:`Our Current Universe`,children:`🌎 Our Galaxy`}),(0,X.jsx)(`button`,{onClick:()=>a(`plasma`),title:`Primordial Chaos`,children:`🔥 Initial State`}),(0,X.jsx)(`button`,{onClick:()=>a(`heat_death`),title:`Absolute Zero Freezing`,children:`❄️ Heat Death`})]}),(0,X.jsxs)(`div`,{className:`control-group epoch-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`epoch`,children:`Cosmological Timeline`}),(0,X.jsx)(`span`,{className:`control-value`,children:[`Plasma`,`Cosmic Web`,`Heat Death`][e.epoch]||`Custom`})]}),(0,X.jsx)(`input`,{id:`epoch`,type:`range`,min:`0`,max:`2`,step:`1`,value:e.epoch,onChange:e=>i(parseInt(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`Travel through Time: Start at the super hot beginning, watch matter pull into a giant spider web, and end with everything frozen and drifting in the dark.`})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`density`,children:`Matter Density (Ωm)`}),(0,X.jsx)(`span`,{className:`control-value`,children:e.density.toFixed(2)})]}),(0,X.jsx)(`input`,{id:`density`,type:`range`,min:`0`,max:`2`,step:`0.05`,value:e.density,onChange:e=>r(`density`,parseFloat(e.target.value))}),(0,X.jsxs)(`div`,{className:`control-tooltip`,children:[`This changes how much "stuff" (gravity) is in the universe. Too much stuff pulls everything together into a crush! Too little stuff lets everything float away forever.`,(0,X.jsx)(`strong`,{style:{display:`block`,marginTop:`4px`,color:`#0df`},children:e.density>1.8?`State: Everything Squished Together!`:e.density<.2?`State: Floating Away...`:`State: Balanced Space Web`})]})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`expansion`,children:`Hubble Expansion (H0)`}),(0,X.jsxs)(`span`,{className:`control-value`,children:[e.expansion.toFixed(1),`x`]})]}),(0,X.jsx)(`input`,{id:`expansion`,type:`range`,min:`0.1`,max:`3`,step:`0.1`,value:e.expansion,onChange:e=>r(`expansion`,parseFloat(e.target.value))}),(0,X.jsxs)(`div`,{className:`control-tooltip`,children:[`This changes how fast the universe is stretching like a giant rubber band!`,(0,X.jsx)(`strong`,{style:{display:`block`,marginTop:`4px`,color:`#0df`},children:e.expansion>2.2?`State: Ripping Apart!`:e.expansion<.5?`State: Frozen in Place`:`State: Growing Smoothly`})]})]}),(0,X.jsxs)(`div`,{className:`control-group`,children:[(0,X.jsxs)(`div`,{className:`control-header`,children:[(0,X.jsx)(`label`,{htmlFor:`darkEnergy`,children:`Dark Energy (ΩΛ)`}),(0,X.jsx)(`span`,{className:`control-value`,children:e.darkEnergy.toFixed(2)})]}),(0,X.jsx)(`input`,{id:`darkEnergy`,type:`range`,min:`0`,max:`2.5`,step:`0.05`,value:e.darkEnergy,onChange:e=>r(`darkEnergy`,parseFloat(e.target.value))}),(0,X.jsx)(`div`,{className:`control-tooltip`,children:`The latent repulsive energy hidden in the vacuum of space. Increases the amplitude of the entropic noise function and thermal bloom.`})]})]})};function ll(){let[e,t]=(0,_.useState)(!0),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)({epoch:0,density:2,expansion:2.5,darkEnergy:2}),[u,d]=(0,_.useState)(`We are at the beginning of Time. Try moving the sliders or your mouse!`);return(0,_.useEffect)(()=>{c.epoch===0?d(`🪐 TIME TRAVEL: The very beginning! It's so hot and crowded that atoms can't even form yet!`):c.epoch===1?d(`🪐 TIME TRAVEL: The Cosmic Web! Gravity is pulling matter together like a giant spider web in space.`):c.epoch===2&&d(`❄️ TIME TRAVEL: The End of Everything. The universe stretched so far that everything froze and drifted apart.`)},[c.epoch]),(0,_.useEffect)(()=>{c.expansion>2&&d(`🚨 WARNING: The universe is stretching way too fast! The space web is ripping apart!`),c.density<.2&&d(`🚨 WARNING: There isn't enough gravity left! Galaxies are floating away from each other.`)},[c.expansion,c.density]),(0,_.useEffect)(()=>{o&&d(`✨ WOW: You made a galaxy! But remember: creating order here makes the rest of space more chaotic!`)},[o]),(0,X.jsxs)(X.Fragment,{children:[(0,X.jsxs)(`div`,{className:`loading-screen ${i?`out`:``}`,children:[(0,X.jsx)(`div`,{className:`loader-ring`}),(0,X.jsx)(`p`,{children:`INITIALIZING MACRO-PHYSICS...`})]}),(0,X.jsx)(sl,{settings:c,onReady:()=>a(!0),onInteract:()=>s(e=>!e)}),(0,X.jsx)(`main`,{className:`hero-overlay`,children:(0,X.jsxs)(`div`,{className:`title-container`,children:[(0,X.jsx)(`h1`,{className:`hero-title`,children:`Cosmic Entropy`}),(0,X.jsxs)(`div`,{className:`subtitle-row`,children:[(0,X.jsx)(`p`,{className:`hero-subtitle`,children:`Transcendental Particles`}),(0,X.jsx)(`button`,{className:`science-trigger`,onClick:()=>r(!n),children:n?`HIDE`:`READ THE SCIENCE`})]}),n&&(0,X.jsxs)(`div`,{className:`science-summary`,children:[(0,X.jsxs)(`p`,{children:[`This sandbox is an interactive WebGL simulation mapping the fundamental struggle that dictates the fate of our universe: the battle between `,(0,X.jsx)(`strong`,{children:`Matter Density (Ωm)`}),` and `,(0,X.jsx)(`strong`,{children:`Dark Energy (ΩΛ)`}),`.`]}),(0,X.jsxs)(`p`,{children:[`As governed by Information Theory and the Second Law of Thermodynamics, entropy represents the "hidden information" of a system. To visually demonstrate this, drag your mouse across the canvas. You will create a vortex of `,(0,X.jsx)(`strong`,{children:`Local Order`}),` (a planetary orbit or star system). However, watch closely: generating this localized structure vigorously agitates the underlying quantum noise field around it, visually demonstrating that creating pockets of order necessitates a massive increase in `,(0,X.jsx)(`strong`,{children:`Global Entropy`}),`!`]}),(0,X.jsx)(`p`,{children:`In the Laboratory, you can travel entirely outside the human timeline. Use the Epoch slider to reverse time to the ultra-dense Planck Epoch ($10^{-43}$ seconds), or slide it forward to witness Heat Death in the Black Hole Era—where matter density reaches zero, and the universe disperses entirely back into the void.`})]})]})}),(0,X.jsx)(`div`,{className:`dashboard-wrapper ${e?`visible`:`hidden`}`,children:(0,X.jsx)(cl,{settings:c,setSettings:l,observation:u})}),(0,X.jsx)(`button`,{className:`info-toggle ${e?`active`:``}`,onClick:()=>t(!e),"aria-label":`Toggle Physics Sandbox`,children:e?(0,X.jsx)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M6 18L18 6M6 6l12 12`})}):(0,X.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,children:[(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z`}),(0,X.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M15 12a3 3 0 11-6 0 3 3 0 016 0z`})]})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(ll,{})}));